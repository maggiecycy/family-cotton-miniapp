 ...
 *
 * 录音（优先 m4a/AAC，体积小；InnerAudioContext 支持）：
 * - 给妈妈：greet-{key}.m4a
 * - 给爸爸：greet-{key}-dad.m4a（没有则回退妈妈版）
 */
...
const STATES = [
  ...
  },
  {
    ...
    audio: '/assets/audio/greet-cheer.m4a',
    audioDad: '/assets/audio/greet-cheer-dad.m4a',
  ...
  },
  {
    ...
    audio: '/assets/audio/greet-playful.m4a',
    audioDad: '/assets/audio/greet-playful-dad.m4a',
  ...
  },
  {
    ...
    audioDad: '/assets/audio/greet-speak-dad.m4a',
